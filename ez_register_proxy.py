...
def register(hostname, username, password, smart_account,
             ...
             export_controlled, proxy_address, port_number, client_id,
             client_secret, vrf, reregister, device_name, i):
    try:
...
if __name__ == '__main__':
    ...
    for i in range(1, sheet.nrows):
        if sheet.cell_value(i, 0) == "":
            ...
            reregister = sheet.cell_value(i, 14)
            device_name = sheet.cell_value(i, 15)
        ...
        t = threading.Thread(target=register,
                             args=(hostname, username, password, reregister,
                                   ...
                                   export_controlled, proxy_address, port_number,
